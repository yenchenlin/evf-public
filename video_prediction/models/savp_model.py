...
class SAVPCell(tf.nn.rnn_cell.RNNCell):
    ...
    def call(self, inputs, states):
        ...
        state_action = []    # Labels for auxiliary task of predicting future states
        state_action_z = []  # Used to concat with conv_rnn's hidden state
        if 'actions' in inputs:
        ...
        if 'embeddings' in inputs:
            state_action_z.append(inputs['embeddings'])
